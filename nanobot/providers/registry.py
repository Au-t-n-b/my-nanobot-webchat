...
PROVIDERS: tuple[ProviderSpec, ...] = (
    ...
    # AWS Bedrock: LiteLLM routes bedrock/* model identifiers through AWS credentials/env.
    ProviderSpec(
        name="bedrock",
        keywords=(
            "bedrock",
    ...
    # Kimi K2.5/K2.6 APIs enforce temperature >= 1.0.
    ProviderSpec(
        name="moonshot",
    ...
    # MiniMax Anthropic-compatible endpoint: supports Anthropic-style models.
    ProviderSpec(
