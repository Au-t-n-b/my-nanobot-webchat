...
export function SidebarPersonalInfo({ variant = "nav", className = "", onMenuAction }: Props) {
  ...
  return (
    <div ref={wrapRef} className={`relative ${className}`}>
      ...
      {open ? (
        <div
          className="absolute right-0 top-full z-[120] mt-2 w-56 overflow-hidden rounded-xl ui-elevation-4 p-1.5 supports-[backdrop-filter]:backdrop-blur-md dark:bg-[color-mix(in_oklab,var(--surface-elevated)_72%,transparent)]"
          role="menu"
        >
